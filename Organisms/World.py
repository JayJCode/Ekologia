...
class World(object):
	...
	def activate_plague(self):
		print("The plague has come to pyworld")
		self.plague_active = True
		self.plague_turns = 2
		for organism in self.organisms:
			organism.apply_plague()

	def addOrganismAtPosition(self, organism, position):
	...
	def makeTurn(self):
		...
		for o in self.organisms:
			o.liveLength -= 1
			#print(str(o.__class__.__name__) + ': has live length: ' + str(o.liveLength))
			o.power += 1
			#print(str(o.__class__.__name__) + ': has power: ' + str(o.power))
			if o.liveLength < 1:
		...
		if self.newOrganisms and self.plague_active:
